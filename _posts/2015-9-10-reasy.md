...
## 安装
 ...
 > 为了方便调用reasy进行编译，reasy为windows系统封装了右键菜单，下载地址为：[Reasy右键菜单安装](https://raw.githubusercontent.com/wEasyTeam/reasy/master/production/addMenu.reg)，另存为bat文件，然后以管理员权限执行即可。效果如图：
